...
public class IncidentLogDAO {
    ...
    public boolean createIncidentLog(IncidentLog incidentLog) {
        String query = "INSERT INTO IncidentLog (vehicle_id, driver_id, incident_type, incident_date_time, incident_location, incident_severity) VALUES (?, ?, ?, ?, ?, ?)";
        ...
        try (Connection connection = DBConnection.getConnection();
            ...
            statement.setString(4, incidentLog.getIncidentDateTime());
    ...
    public List<IncidentLog> readIncidentLogs() {
        ...
        try (Connection connection = DBConnection.getConnection();
            ...
            while (resultSet.next()) {
                ...
                incidentLog.setIncidentDateTime(resultSet.getString("incident_date_time"));
